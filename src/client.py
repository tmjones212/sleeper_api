...
class SleeperAPI:
	...
	def load_players_from_file(self, filename="data/players.json") -> Dict[str, Player]:
	...
	def load_cache(self, filename="data/api_cache.json"):
		if os.path.exists(filename):
			with open(filename, 'r') as f:
				self.cache = json.load(f)

	def save_cache(self, filename="data/api_cache.json"):
		os.makedirs(os.path.dirname(filename), exist_ok=True)
		with open(filename, 'w') as f:
	...
	def load_stats_cache(self, filename="data/stats_cache.json"):
		if os.path.exists(filename):
			with open(filename, 'r') as f:
				data = json.load(f)
	...
	def load_projections_cache(self, filename="data/projections_cache.json"):
		if os.path.exists(filename):
			with open(filename, 'r') as f:
				data = json.load(f)
	...
	def load_matchups_cache(self, filename="data/matchups_cache.json"):
		if os.path.exists(filename):
			with open(filename, 'r') as f:
